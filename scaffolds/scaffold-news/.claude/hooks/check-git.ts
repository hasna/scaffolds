...
function findProjectRoot(inputCwd?: string): string {
  const possiblePaths = [
    inputCwd,
    PROJECT_ROOT,
    "/Users/hasna/Workspace/dev/hasnaxyz/scaffold/scaffolddev/scaffold-saas",
...
5. Check remote with \`git remote -v\`, create PRIVATE repo if needed: \`gh repo create hasnaxyz/scaffold-saas --private --source=. --remote=origin\`
