 ...
 * - team:manage: Invite/remove team members, change roles
 * - billing:read: View billing info, invoices
 * - billing:manage: Manage subscriptions (requires session auth)
...
export const API_KEY_SCOPE_GROUPS = {
  ...
  "Read Only": ["read", "team:read", "billing:read"],
  Standard: ["read", "write", "assistant:use"],
} as const;
