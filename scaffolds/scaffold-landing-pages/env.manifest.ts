...
export const ENV_VARS: EnvVar[] = [
  ...
  // Database
  {
    ...
    default: "postgresql://postgres:postgres@localhost:5432/scaffold_landing_pages",
    required: true,
    secret: true,
    group: "Database",
  ...
  // Redis
  {
    ...
    description: "Redis URL for caching and workers. Start with: docker compose up -d redis",
