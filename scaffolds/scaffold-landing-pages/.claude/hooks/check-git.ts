...
function findProjectRoot(inputCwd?: string): string {
  const possiblePaths = [
    inputCwd,
    PROJECT_ROOT,
    "/Users/hasna/Workspace/dev/hasnaxyz/scaffold/scaffolddev/scaffold-landing-pages",
...
5. Check remote with \`git remote -v\`, create PRIVATE repo if needed: \`gh repo create hasnaxyz/scaffold-landing-pages --private --source=. --remote=origin\`
