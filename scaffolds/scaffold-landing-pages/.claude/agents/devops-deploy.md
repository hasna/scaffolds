...
COPY . .
RUN bun run build --filter @scaffold-landing-pages/web
...
docker build -t scaffold-landing-pages -f apps/web/Dockerfile .
...
docker push ghcr.io/org/scaffold-landing-pages:latest
