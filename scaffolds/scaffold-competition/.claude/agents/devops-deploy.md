...
COPY . .
RUN bun run build --filter @scaffold-competition/web
...
services:
  web:
    ...
    ports:
      - "4020:4020"
    environment:
      - DATABASE_URL=postgresql://postgres:postgres@db:5432/scaffold_competition
  ...
  db:
    ...
    environment:
      ...
      POSTGRES_DB: scaffold_competition
    volumes:
...
jobs:
  ...
  test:
    ...
    services:
      postgres:
        ...
        env:
          POSTGRES_USER: postgres
          POSTGRES_PASSWORD: postgres
          POSTGRES_DB: scaffold_competition_test
        ports:
          - 5432:5432
        options: >-
    ...
    steps:
      ...
      - run: bun test
        env:
          DATABASE_URL: postgresql://postgres:postgres@localhost:5432/scaffold_competition_test
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/scaffold_competition
...
docker build -t scaffold-competition -f apps/web/Dockerfile .
...
docker push ghcr.io/org/scaffold-competition:latest
